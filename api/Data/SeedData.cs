...
/// <summary>
/// Class that generates seed data when the DB is created.
/// </summary>
public static class SeedData
{
    public static void Seed(ModelBuilder builder) 
    {
        //// HasData -> checks if the list of data is already present in the DB.
        //// ** this creates the data via a migration.
